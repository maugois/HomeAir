    ...
    <section id="area-servicos" class="area-espacamento">
        ...
        <div id="itens-servicos">
            <ul class="lista-servicos">
                ...
                <li><img class="img-l-servicos" src="images/servicos1.webp" alt=""><p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ex sint hic asperiores sequi odit, a consequatur in eaque illum? Illum accusamus nulla, et veniam nemo repellendus fugit voluptate ex. Quo.</p></li>
                <li><img class="img-l-servicos" src="images/servicos2.webp" alt=""><p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eius cupiditate accusamus, laboriosam tempore ipsam magni. Aliquam, amet repellat sed quos, laudantium similique, vitae odio rerum vel iste quod recusandae ducimus!</p></li>
            </ul>

            <ul class="lista-servicos">
                <li><p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maxime ad omnis tenetur, provident, ab tempore nisi nihil fuga sequi quos error, libero officia repudiandae nemo molestias dolorem cum eos illo.</p><img class="img-l-servicos" src="images/servicos3.jpg" alt=""></li>
                <li><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor autem magni reiciendis maiores labore suscipit sed facere aspernatur rem repellat ipsam, esse, molestiae iure ex atque maxime deserunt blanditiis ratione.</p><img class="img-l-servicos" src="images/servicos4.jpg" alt=""></li>
                <li><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat voluptatum rem repudiandae magnam quos ipsa ab magni nisi? Possimus ad optio, non voluptas nobis doloremque similique reprehenderit aperiam laboriosam doloribus.</p><img class="img-l-servicos" src="images/servicos5.jpg" alt=""></li>
            </ul>
        </div>
    </section>
